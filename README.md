...
npm install
```
3. Configure the environment variables: create a `.env` file in the root directory and add your TMDB API Read Access Token (VITE_API_RA_TOKEN) key following the example below:
```
